...
void draw_oled(int msg) {
    ...
    do{
    switch(msg){
        case 0:  oled.drawStr(10,0,F("ERROREA"),1); 
                 break;
        case 1:  oled.drawStr(13,10,F("EZ DU"),1); 
                 oled.drawStr(10,20,F("DETEKTATZEN"),1);
                 oled.drawChar(100,0,voltage/10+'0');
                 oled.drawChar(106,0,'.');
                 oled.drawChar(112,0,voltage%10+'0');
                 oled.drawChar(118,0,'V');
                 oled.drawStr(84,14,F("DBosco"),1); 
                 if (draw_Red) 
                    oled.drawStr(84,24,F("O2"),1); 
                 else
        ...
        case 2:  print_digit(86,0,beatAvg);
                 ...
                 break;
        case 3:  oled.drawStr(50,10,F("KAIXO"),1);
                 oled.drawStr(18,20,F("Aritz Eneko Jone"),1);
                 oled.drawXBMP(6,8,16,16,heart_bits);
                 oled.drawXBMP(106,8,16,16,heart_bits);
                 break;
        case 4:  oled.drawStr(20,12,F("ITZALTZEN"),1);
                 oled.drawChar(80,12,10-sleep_counter/10+'0');
                 oled.drawChar(87,12,'s');
                 break;
        }
    } while (oled.nextPage());
}
